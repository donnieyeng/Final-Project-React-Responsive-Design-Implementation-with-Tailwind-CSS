...
import techniciansImg from "../../assets/images/technician.webp";
...
export default function Features() {
  ...
  return (
    <section id="services" className="bg-gray-100 py-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, idx) => (
            <Card key={idx} title={feature.title} desc={feature.desc} img={feature.img} />
          ))}
        </div>
      </div>
    </section>
